...
class GAT(torch.nn.Module):
    ...
    The most interesting and hardest one to understand is implementation #3 (layer_type=2).
...
class GATLayerImp1(GATLayer):
    ...
    def __init__(self, num_in_features, num_out_features, num_of_heads, concat=True, activation=nn.ELU(),
        ...
        super().__init__(num_in_features, num_out_features, num_of_heads, 2, concat, activation, dropout_prob,
                         add_skip_connection, bias, log_attention_weights)
